...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default="data/astrosite/spectrograms_training", help='Path to dataset (default: data/astrosite/spectrograms_training)')
    parser.add_argument('--num_classes', type=int, default=2, help='Number of classes (default: 5)')
